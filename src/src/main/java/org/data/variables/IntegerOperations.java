...
public class IntegerOperations {
    ...
    public static Integer getIntegerBoxing(int i) {
        return (Integer) i;
    }
...
// NOT a numeric string. Returns null if property not found.
    public static Integer getIntegerOfString(String str) {
        return Integer.getInteger(str);
    }

    // Like above, but returns the default val if the system property is missing.
    public static Integer getIntegerOfString(String str, int val) {
...
// Throws NumberFormatException if the string is not a valid int.
    public static Integer getIntegerValueOfString(String str) {
...
// Returns int, but the bits may represent a negative number if > Integer.MAX_VALUE.
    public static Integer parseUnsignedInteger(String str) {
